...
export default function FinishedProductsCatalog({ indexSlot }: { indexSlot?: React.ReactNode }) {
  ...
  return (
    <div className="catalogPage min-h-screen">
      ...
      {/* Server-rendered catalogue index. Passed in as a prop from the
          server page so it renders to HTML — the grid above is built from a
          client fetch and never reaches a crawler. */}
      {indexSlot}
      <Footer />
    </div>
  )
