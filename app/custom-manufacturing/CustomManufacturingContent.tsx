...
export default function CustomManufacturingContent({ oemSlot }: { oemSlot?: React.ReactNode }) {
  ...
  return (
    <>
      ...
      <main className="cmPage">
        ...
        {/* Server-rendered OEM/ODM, MOQ and tech-pack detail. Passed in from
            the server page so the minimums can be read from the live
            catalogue rather than hardcoded into this client component. */}
        {oemSlot}
